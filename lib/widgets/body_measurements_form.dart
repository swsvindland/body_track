                    ...
                    child: Button(
                      onPressed: () async {
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          setState(() {
                            showBloodPressureInput = true;
                          });
                        }
                      },
                      child: const Text('Add Blood Pressure'),
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(4),
